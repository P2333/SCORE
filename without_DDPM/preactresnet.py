...
def PreActResNet18(num_classes=10, activation='ReLU', softplus_beta=1):
    return PreActResNet(PreActBlock, [2,2,2,2], num_classes=num_classes, activation=activation, softplus_beta=softplus_beta)
